export const experience = [
  ...
  },
  {
    ...
    tags: ['vMix', 'Live Streaming', 'FastAPI'],
  },
  {
    date: 'Ongoing',
    role: 'Software Developer',
    company: 'AreteForge',
    desc: 'Backend feature development in Python for production-grade software. Practising full-stack across APIs and frontends, working in agile sprints with Git and Jira.',
    tags: ['Python', 'Git', 'Jira'],
  },
  {
    date: 'Ongoing',
    role: 'Backend Developer',
    company: 'Meditel Inc. (Contract)',
    desc: 'Lead backend developer on StrokeNet. Built FastAPI services and the real-time alert pipeline, collaborating with frontend on React + Tailwind interfaces.',
    tags: ['FastAPI', 'React', 'Celery'],
  },
  {
    date: 'Ongoing',
  ...
  },
  {
    ...
    company: 'WAICA',
    desc: 'Content creation, social media management, and growth campaigns building online brand presence and audience engagement across digital channels.',
    tags: ['Growth', 'Content'],
  },
];
